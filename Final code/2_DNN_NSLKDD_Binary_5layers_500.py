...
model = tf.keras.models.load_model("DNN_NSLKDD_model_epochs_500_001v2.h5")
...
NN.fit(x=train, y=target, epochs=100, validation_split=0.1, batch_size=64, callbacks=[tsb])
...
plot_confusion_matrix(cm, classes=class_names,
                      title='NNSL_KDD Binary_Class 100-epochs 5-layers')
